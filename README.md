...
## Experimenting with different toroid materials
For RF transformers I had on hand #31, #43 and #61 core materials. I had too few core combinations for #31 so I didn't include those in the test, leaving only material #43 and #61.
### Material 43
...
Blast from the past; Litz wire was used in the early days of radio for some assumed performance gains. Litz wire consists of dozens of very thin individually coated copper wires bunched together. Since RF travels only on the surface of the wire, this gives the overall cable much more surface area than monofillar wire. In time, the supposed performance gains were disproven in practical situations except in some very narrow frequency range, and regular single-core enameled copper wire became the norm for RF transformers. Nevertheless, I wanted to see if there are any measurable gains for using Litz wire.
